...
class _AuthenticationState extends State<Authentication> {
  ...
  Future<void> anon() async {
    try {
      ...
      if (mounted) {
        // QUI devi dire all'app dove andare!
        // Esempio: vai alla pagina del gioco (sostituisci GamePage con il nome della tua pagina)
      ...
      // IMPORTANTE: Non lasciare il catch vuoto!
      if (mounted) {
